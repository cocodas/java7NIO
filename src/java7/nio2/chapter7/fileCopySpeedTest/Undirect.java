...
public class Undirect extends BasicSetting{

	public void undirect(Path copyFrom, Path copyTo) {
		deleteCopied(copyTo);
		System.out.println("***** 비다이렉트 버퍼를 사용 하여 파일 복사 *****");
		...
		try {
			...
			System.out.println("비다이렉트 버퍼 경과 시간 : " + "[" +(elapsedTime/1000000000.0) +"]seconds");
